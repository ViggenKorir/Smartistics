...
const Footer = () => (
  <footer className="bg-black text-white py-10 px-8 rounded-t-4xl mt-8">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
      <div>
        <h3 className="font-bold text-lg mb-2">Smartistics</h3>
      ...
      <div>
        ...
        <ul className="space-y-1 text-sm text-gray-400">
          <li>Email: <a href="mailto:info@smartistics.com" className="hover:text-lime-400">info@smartistics.com</a></li>
    ...
    <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-500 text-xs">
      &copy; {new Date().getFullYear()} Smartistics. All rights reserved.
    </div>
  </footer>
);
